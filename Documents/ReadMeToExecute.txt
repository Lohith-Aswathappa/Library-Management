...
1. Run the Library.jar executable file by double clicking it.
2. Or extract the project from Library.zip (present in "Application" folder) and import that on any Java supported IDE. Begin execution by running the MainPage.java.
